...
import se.kth.ssvl.tslab.bytewalla.androiddtn.servlib.conv_layers.TCPListener;
...
import se.kth.ssvl.tslab.bytewalla.androiddtn.servlib.conv_layers.StreamConvergenceLayer;
...
public class TCPConvergenceLayer extends StreamConvergenceLayer implements Serializable{
	 ...
	 * WifiManager
	 */
	private WifiManager mWifi = (WifiManager) DTNService.context()
