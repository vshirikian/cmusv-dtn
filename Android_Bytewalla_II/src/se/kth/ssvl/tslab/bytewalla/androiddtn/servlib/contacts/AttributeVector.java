...
/**
 * This class represents a list of NamedAttribute
 * 
 * @author María José Peroza Marval (mjpm@kth.se)
 */

public class AttributeVector extends ArrayList<NamedAttribute> {

	/**
	 * Unique identifier according to Java Serializable specification
	 */
	private static final long serialVersionUID = 1337631354289904583L;
