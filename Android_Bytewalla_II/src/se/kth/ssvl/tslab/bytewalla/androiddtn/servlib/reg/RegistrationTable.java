...
public class RegistrationTable{
	...
	{
		Log.e(TAG, "entering cleanup_api_temp_folder");
		Context context = DTNService.context();
		//DTNManager.me.getResources().getString(R.string.keyStoreFilePath))
		
		//Context context = DTNManager.me.context();
		//Resources res=context.getResources();
		
		String TempPrefixName = DTNManager.me.getResources().getString(R.string.DTNAPITempFilePrefix);
		File dir = DTNManager.me.getDir(TempPrefixName, Context.MODE_PRIVATE);
