...
public class BlockInfo implements Serializable {
	 ...
	 * @param owner (IN): BlockProcessor to work with this block.
	 ...
	 * 
	 * Includes: LIST_NONE(0x00), LIST_RECEIVED(0x01), LIST_API(0x02), LIST_EXT(0x03), LIST_XMIT(0x04)
	 */
	...
	/**
	 * return Abstract structure used, for example, for the Abstract Security Block.
	*/
	...
	*/
	...
	/**
	 * The full length of this block calculated by the summation of data_offset and data_length
	 * @return
	 */
	...
	/**
	 * Flag to indicate whether this BlockInfo has already been processed by the BlockProcessor
	 * @return
	 */
	...
	/**
	 * Getter for the type of Block. Ex: PRIMARY_BLOCK, PAYLOAD_BLOCK, BUNDLE_AUTHENTICATION_BLOCK, PAYLOAD_SECURITY_BLOCK, CONFIDENTIALITY_BLOCK
	 * @return
	 */
	...
	public int flags() {
		 if (type() == BundleProtocol.bundle_block_type_t.PRIMARY_BLOCK) {
		    ...
		    BufferHelper.read_SDNV(contents_, BundleProtocol.PREAMBLE_FIXED_LENGTH, flags);
		    assert(flags[0] > 0) ;
		    return flags[0];
	}

	/**
	 * Set Block Processing control flag into the block contents.
	 ...
	 * XXX sd. It contains the binary data represented in this block. Only the payload or the whole block?
	 */
	...
	/**
	 * Offset of first byte of the block data (without the preamble).
	 */
