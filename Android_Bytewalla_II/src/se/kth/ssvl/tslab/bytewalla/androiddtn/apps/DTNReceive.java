...
public static final String USER_PREFERENCE = "USER_PREFERENCES";
	...
	{
		String dest_EID_text=prefs.getString(PREF_MY_ENDPOINT, "dtn://node.bytewalla.com/test");
	...
	{
		closeButton = (Button) this.findViewById(R.id.DTNApps_DTNReceive_CloseButton);
		DestEIDEditText = (EditText) this.findViewById(R.id.DTNApps_DTNReceive_DestEIDEditText);
		
		receiveButton = (Button) this.findViewById(R.id.DTNApps_DTNReceive_ReceiveButton);
		resultTextView = (TextView) this.findViewById(R.id.DTNApps_DTNReceive_ResultTextView);
	...
	private void savePreferences() {
		String dest_EID_text=DestEIDEditText.getText().toString();
			...
			Editor editor = prefs.edit();
			  editor.putString(PREF_MY_ENDPOINT, dest_EID_text);
