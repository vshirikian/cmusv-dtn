...
public class BufferHelper {
	 ...
	 * Otherwise, do nothing ( This will make the buffer not changed at all )
	 ...
	 * @param buf_offset ():
	 * @param result (OUT): result of the conversion
	 ...
	 * The position will be reverted back to original position for both of ByteBuffer
