...
public class Dictionary implements Serializable {
     ...
     * @param eid (IN): EndpointID to find in dictionary
     * @param scheme_offset (OUT):  Set scheme_offset on the first index 
     * of scheme_offset array if scheme part of endpoint id is found.
     * @param ssp_offset (OUT): Set ssp_offset on the first index
