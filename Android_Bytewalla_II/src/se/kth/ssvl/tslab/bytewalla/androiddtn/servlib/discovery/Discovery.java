...
import se.kth.ssvl.tslab.bytewalla.androiddtn.servlib.discovery.Announce;
...
public abstract class Discovery {
	...
	public void handle_neighbor_discovered(String cl_type, String cl_addr,
		...
		Link link = cm.find_link_to(cl, "", remote_eid,
				Link.link_type_t.LINK_INVALID, 0xffffffff);

		if (link == null) {
			link = cm.new_opportunistic_link(cl, cl_addr, remote_eid, null);
			if (link == null) {
