...
public class SDNV {
    ...
    /**
     * Function to encode the given value and store in the buffer. Sets position at the end of buffer
    ...
    /**
     * Decode bytes after reading from the given buffer. Updates bp.position with the new value.
     * @param bp Buffer with bytes to read and decode
     * @param len Total length of the buffer. Only useful when the SDNV is mal-formed, to prevent infinite loop.
    ...
    */
    ...
    /**
     * Function to encode the the given value and store in the buffer. Sets position at the end of buffer
     * @param val (IN): Value to encode
     * @param bp (OUT): Buffer to store the encoded value
     * @param len (IN): Number of bytes available in the buffer
     * @return Length of the stored bytes after encoding on the buffer
     */
    ...
    /**
     * Function to encode the the given value and store in the buffer. Sets the position at the end of buffer
     * @param val (IN):Value to encode
     * @param bp (OUT): Buffer to store the encoded value
     * @return Length of the stored bytes after encoding on the buffer
     */
